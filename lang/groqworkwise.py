...
ll_model = "deepseek-r1-distill-llama-70b"
db_path = "./docs"
db_name = "cerebro"
folder_path = "./files"
st.title("💻 Work Wise")
...
### LLM Setup
llm = ChatGroq(model=ll_model)



_prompt = """Answer from context provided only. If you don't have the information to answer a question, say 'I don't know'.
### Context:
{context}
### Question:
{input}
